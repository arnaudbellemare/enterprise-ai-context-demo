                      ...
                      <div className="bg-gray-900 border border-gray-700 p-3 rounded">
                        ...
                        <div className="space-y-1 text-xs font-mono">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-blue-400">93%</span>
                          </div>
                          <div className="flex justify-between">
                  ...
                  <div className="bg-black border border-gray-600 p-4 rounded">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                      <button 
                        ...
                        className="bg-gray-700 hover:bg-gray-600 text-white p-3 rounded text-sm font-mono transition-colors border border-gray-500 hover:border-gray-400 w-full"
                      >
                        🔄 TEST NEW QUERY
                      </button>
                      <button 
